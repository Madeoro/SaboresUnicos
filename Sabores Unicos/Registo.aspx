<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Registo.aspx.cs" Inherits="Sabores_Unicos.Registo" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <table style="width:100%;">
        <tr>
            ...
            <td class="auto-style1" rowspan="17">&nbsp;</td>
        </tr>
        <tr>
        ...
        <tr>
            <td class="auto-style5" dir="rtl">
                <asp:Label ID="lblNome" runat="server" style="color: #CBC750; font-size: medium" Text="Username"></asp:Label>
            </td>
            <td class="auto-style13">
                <asp:TextBox ID="txtNome" runat="server" ValidationGroup="Registar" Width="188px"></asp:TextBox>
        ...
        <tr>
            ...
            <td class="auto-style4">
                <asp:TextBox ID="txtEmail" runat="server" ValidationGroup="Registar" Width="188px"></asp:TextBox>
                ...
                <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ControlToValidate="txtEmail" ForeColor="#CC0000" ValidationExpression="\w+([-+.']\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*" ValidationGroup="Registar">Inválido</asp:RegularExpressionValidator>
            </td>
        </tr>
        <tr>
            <td class="auto-style5" dir="rtl">
            ...
            <td class="auto-style4">
                <asp:TextBox ID="txtPass1" runat="server" TextMode="Password" ValidationGroup="Registar" Width="188px"></asp:TextBox>
        ...
        <tr>
            ...
            <td class="auto-style4">
                <asp:TextBox ID="txtPass2" runat="server" TextMode="Password" ValidationGroup="Registar" Width="188px"></asp:TextBox>
        ...
        <tr>
            ...
            <td class="auto-style4">
                <asp:TextBox ID="txtMorada" runat="server" ValidationGroup="Registar" Width="188px"></asp:TextBox>
        ...
        <tr>
            ...
            <td class="auto-style15">
                <asp:TextBox ID="txtCodigo" runat="server" ValidationGroup="Registar" Width="188px"></asp:TextBox>
        ...
        <tr>
            ...
            <td class="auto-style4">
                <asp:TextBox ID="txtLocalidade" runat="server" ValidationGroup="Registar" Width="188px"></asp:TextBox>
        ...
        <tr>
            ...
            <td class="auto-style4">
                <asp:TextBox ID="txtTelefone" runat="server" OnTextChanged="txtTelefone_TextChanged" ValidationGroup="Registar" Width="188px"></asp:TextBox>
        ...
        <tr>
            ...
            <td class="auto-style13">
                <asp:TextBox ID="txtDataNascimento" runat="server" OnTextChanged="txtTelefone_TextChanged" TextMode="Date" ValidationGroup="Registar" Width="188px"></asp:TextBox>
        ...
        <tr>
            ...
            <td class="auto-style13">
                <asp:TextBox ID="txtNIF" runat="server" OnTextChanged="txtTelefone_TextChanged" ValidationGroup="Registar" Width="188px"></asp:TextBox>
        ...
        <tr>
            <td class="auto-style5">&nbsp;</td>
            <td class="auto-style4">
                <asp:Button ID="btnConcluir" runat="server" OnClick="btnConcluir_Click" Text="Concluir" ValidationGroup="Registar" Width="73px" CssClass="btnLogin" />
